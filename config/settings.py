...
SECRET_KEY = 'django-insecure-l04y+qs_w7obge+kib+&13hat-#dyrb51j_dfkf3(3kj872ss4'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['templates', 'dashboard_frontend/build'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / 'static', BASE_DIR / 'dashboard_frontend/build/static']
